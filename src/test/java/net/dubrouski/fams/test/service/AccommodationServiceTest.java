...
public class AccommodationServiceTest {
	...
	public void ListAll(){
		...
		Place p = accommodationHelper.getPlace(false, "minor place", BigDecimal.valueOf(568.4));
		accommodationService.save(p);
		Place r = accommodationHelper.getPlace(false, "I like this space", BigDecimal.valueOf(568.4));
		accommodationService.save(r);
		Place s = accommodationHelper.getPlace(false, "major place", BigDecimal.valueOf(568.4));
		accommodationService.save(s);
		
		List<AccommodationUnit> found = accommodationService.listAccommodations();
	...
	public void listByType(){
		int initialPlaces = accommodationService.listAccommodationsByType("place").size();
		Place p = accommodationHelper.getPlace(false, "minor place", BigDecimal.valueOf(568.4));
		accommodationService.save(p);
		Place r = accommodationHelper.getPlace(false, "I like this space", BigDecimal.valueOf(568.4));
		accommodationService.save(r);
		
		int initialRooms = accommodationService.listAccommodationsByType("room").size();
		Room s = accommodationHelper.getRoom(false, "major place", BigDecimal.valueOf(568.4));
		accommodationService.save(s);
		
		List<AccommodationUnit> foundPlaces = accommodationService.listAccommodationsByType("place");
		List<AccommodationUnit> foundRooms = accommodationService.listAccommodationsByType("room");
